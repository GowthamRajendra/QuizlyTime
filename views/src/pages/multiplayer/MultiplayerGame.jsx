...
// multiplayer quiz between players, synced by backend
function MultiplayerGame() {
    ...
    useEffect(() => {
        ...
        const handleAnswerChecked = ({correct_answer, question_index, answers}) => {
    ...
    return (
        ...
        (questions.length === 0)
        ? <Navigate to='/multiplayer/lobby' replace />
